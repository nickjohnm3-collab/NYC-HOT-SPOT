...
const RESTAURANTS = [
  ...
  // ── Eater NY Heatmap & Tracker additions ──
  { id:47, name:"Bufón",                      neighborhood:"Lower East Side",   cuisine:"Seafood / Steak",         price:3, difficulty:3, opened:"Nov 2025",       openedDate:new Date("2025-11-15"), status:"open", address:"78 Rivington St",        vibe:"Swanky & Raw",            isBar:false, reservation:"Walk-in Friendly",          dressCode:"Smart Casual",            mealPeriods:["Dinner"],                               homepage:"https://www.bufonnyc.com",                 chef:"The swanky Lower East Side follow-up to West Village wine bar Demo, from chefs Quang Nguyen and Dina Fan. Bluefin tuna carpaccio, beans with dried scallops, grilled mackerel, steak selection, and fries. Robust natural wine list curated by Jacob Nass and Pierre Derrien.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/bufon"},{name:"Google",url:"https://www.google.com/search?q=Bufon+NYC+reservation"}] },
  { id:48, name:"Giulietta",                  neighborhood:"Midtown",           cuisine:"Italian",                 price:3, difficulty:2, opened:"Feb 2026",       openedDate:new Date("2026-02-11"), status:"open", address:"200 Park Ave (MetLife)", vibe:"Coastal & Grand",         isBar:false, reservation:"Walk-in Friendly",          dressCode:"Smart Casual",            mealPeriods:["Breakfast","Lunch","Dinner"],            homepage:"https://www.giuliettanyc.com",              chef:"An 11,000-square-foot all-day Italian from La Pecora Bianca owner Mark Barak at the base of the MetLife Building. Culinary director Ed Scarpone (Daniel Boulud, Stephen Starr) runs a menu of whipped ricotta toast, Neapolitan pizzas, pastas, and two-pound lobster fra diavolo. Mid-century coastal Italian design with 275 seats.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/giulietta"},{name:"Google",url:"https://www.google.com/search?q=Giulietta+NYC+MetLife+reservation"}] },
  { id:49, name:"Verde",                      neighborhood:"Chelsea",           cuisine:"Mediterranean",           price:3, difficulty:3, opened:"Feb 27, 2026",   openedDate:new Date("2026-02-27"), status:"open", address:"85 10th Ave",           vibe:"Festive & Scene-y",       isBar:false, reservation:"Booking 1 week out",        dressCode:"Smart Casual",            mealPeriods:["Dinner","Late Night"],                   homepage:"https://verde-nyc.com",                    chef:"From Yeels Group (Paris, Saint Tropez, Dubai), Verde features large-format meats, a wide selection of seafood and crudos, pastas, and pizzas. The draw is the nightly transformation: when dinner fades, a DJ and party take over. First US location.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/verde"},{name:"Google",url:"https://www.google.com/search?q=Verde+Chelsea+NYC+reservation"}] },
  { id:50, name:"Anbā",                       neighborhood:"Lower East Side",   cuisine:"Japanese Omakase",        price:4, difficulty:4, opened:"Feb 12, 2026",   openedDate:new Date("2026-02-12"), status:"open", address:"92 Ludlow St",          vibe:"Intimate & Refined",      isBar:false, reservation:"Booking 2 weeks out",       dressCode:"Smart Casual",            mealPeriods:["Dinner"],                               homepage:"https://anbanewyork.com",                  chef:"A 10-seat omakase counter led by an all-women culinary team. Chef Ambrely Ouimette trained under Nobu Matsuhisa and offers a 16-course tasting menu ($220) rooted in classical Japanese techniques, fermentation, and aging. Front cocktail lounge transitions to late-night DJ program.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/anba"},{name:"Google",url:"https://www.google.com/search?q=Anba+NYC+omakase+reservation"}] },
  { id:51, name:"Dahla",                      neighborhood:"West Village",      cuisine:"Modern Thai",             price:3, difficulty:3, opened:"Feb 10, 2026",   openedDate:new Date("2026-02-10"), status:"open", address:"202 W 14th St",         vibe:"Inventive & Sleek",       isBar:false, reservation:"Booking 1 week out",        dressCode:"Smart Casual",            mealPeriods:["Dinner"],                               homepage:"https://www.dahlanewyork.com",             chef:"Modern Thai with dishes like khao soi featuring homemade mafaldine and potato terrine topped with caviar and Thai basil aioli. Creative cocktails include the Marigold (soba cha, shiitake, parmesan crisp) and the Osaka Fern (strawberry gin, matcha, Calpico).", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/dahla"},{name:"Google",url:"https://www.google.com/search?q=Dahla+West+Village+NYC+reservation"}] },
  { id:52, name:"Delos",                      neighborhood:"Midtown",           cuisine:"Greek Seafood",           price:3, difficulty:2, opened:"Feb 3, 2026",    openedDate:new Date("2026-02-03"), status:"open", address:"1185 6th Ave",          vibe:"Mediterranean & Grand",   isBar:false, reservation:"Walk-in Friendly",          dressCode:"Smart Casual",            mealPeriods:["Lunch","Dinner"],                        homepage:"https://delosgr.com",                      chef:"Part of a boom of new Greek openings across NYC. Family-style menu leaning heavily on seafood — raw and cooked preparations — plus traditional dishes like spanakopita and dolmadakia. A $35 two-course prix fixe lunch is available daily.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/delos"},{name:"Google",url:"https://www.google.com/search?q=Delos+NYC+Greek+restaurant+reservation"}] },
  { id:53, name:"Lily Pond",                  neighborhood:"West Village",      cuisine:"American Bistro",         price:2, difficulty:1, opened:"Feb 26, 2026",   openedDate:new Date("2026-02-26"), status:"open", address:"183 W 10th St",         vibe:"Dreamy & Chic",           isBar:false, reservation:"Walk-in Friendly",          dressCode:"Casual",                  mealPeriods:["Breakfast","Lunch","Dinner"],            homepage:"https://www.lilypondclub.com",             chef:"A dreamy 25-seat bistro with daily brunch service. Club sandwich, avocado burger, French toast, and a kimchi Reuben. Korean influences via coloring pages and tea service. LA's Bravo Toast coffee program. The aesthetic channels summer in the East Hamptons and Monet's water lilies.", bookingLinks:[{name:"Walk-ins",url:"https://www.lilypondclub.com"},{name:"Google",url:"https://www.google.com/search?q=Lily+Pond+West+Village+NYC"}] },
  { id:54, name:"Nounou",                     neighborhood:"East Village",      cuisine:"Noodle Bar",              price:2, difficulty:2, opened:"Feb 2, 2026",    openedDate:new Date("2026-02-02"), status:"open", address:"71 1st Ave",            vibe:"Bold & Slurpy",           isBar:false, reservation:"Walk-in Friendly",          dressCode:"Casual",                  mealPeriods:["Dinner"],                               homepage:"https://www.nounounyc.com",                chef:"A noodle bar serving brothy and dry bowls drawing on global flavors. Potato noodles in Thai chile-lime broth with seafood, squid ink pasta with crabmeat and brown butter, udon with steak and Sichuan peppercorn, spinach noodles and chicken in miso broth.", bookingLinks:[{name:"Walk-ins",url:"https://www.nounounyc.com"},{name:"Google",url:"https://www.google.com/search?q=Nounou+NYC+noodle+bar"}] },
  { id:55, name:"Piadi by La Piadineria",     neighborhood:"Flatiron",          cuisine:"Italian Fast-Casual",     price:1, difficulty:1, opened:"Jan 2026",       openedDate:new Date("2026-01-15"), status:"open", address:"18 E 23rd St",          vibe:"Quick & Authentic",       isBar:false, reservation:"Walk-in Only",              dressCode:"Casual",                  mealPeriods:["Lunch","Dinner"],                        homepage:"https://piadi.com",                        chef:"Italy's biggest fast-casual chain (500+ locations) makes its American debut at Madison Square Park. Specializes in piadina — thin Emilia-Romagna flatbread freshly rolled, baked, and stuffed with prosciutto, soft cheese, and arugula. $11–$17 per piadina.", bookingLinks:[{name:"Walk-ins Only",url:"https://piadi.com"},{name:"Google",url:"https://www.google.com/search?q=Piadi+La+Piadineria+NYC"}] },
  { id:56, name:"Bar Maeda",                  neighborhood:"Tribeca",           cuisine:"Cocktail Bar",            price:3, difficulty:3, opened:"Feb 13, 2026",   openedDate:new Date("2026-02-13"), status:"open", address:"70 Charlton St",        vibe:"Refined & Japanese",      isBar:true,  reservation:"Walk-in Friendly",          dressCode:"Smart Casual",            mealPeriods:["Evening","Late Night"],                  homepage:"https://www.barmaeda.nyc",                 chef:"From bartender Yoshikatsu Maeda, an alum of the World's 50 Best-recognized Mori Bar in Tokyo. Martinis made with Japanese gin. Attached to omakase restaurant Sushidokoro Mekumi.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/bar-maeda"},{name:"Google",url:"https://www.google.com/search?q=Bar+Maeda+NYC"}] },
  { id:57, name:"Cô Lạc",                    neighborhood:"East Village",      cuisine:"Vietnamese Seafood",      price:2, difficulty:2, opened:"Feb 2026",       openedDate:new Date("2026-02-15"), status:"open", address:"234 E 4th St",          vibe:"Bright & Coastal",        isBar:false, reservation:"Walk-in Friendly",          dressCode:"Casual",                  mealPeriods:["Dinner"],                               homepage:"https://www.instagram.com/colacnyc/",      chef:"Helen Nguyen, owner of Saigon Social, opened this Vietnamese seafood restaurant in the former Van Đa space. A fresh addition to the East Village's ever-evolving Vietnamese dining scene.", bookingLinks:[{name:"Walk-ins",url:"https://www.google.com/search?q=Co+Lac+NYC+Vietnamese"},{name:"Google",url:"https://www.google.com/search?q=Co+Lac+NYC+reservation"}] },
  { id:58, name:"Skëwr",                      neighborhood:"NoMad",             cuisine:"Wood-Fired",              price:3, difficulty:2, opened:"Feb 9, 2026",    openedDate:new Date("2026-02-09"), status:"open", address:"127 E 27th St",         vibe:"Smoky & Social",          isBar:false, reservation:"Walk-in Friendly",          dressCode:"Smart Casual",            mealPeriods:["Dinner"],                               homepage:"https://www.google.com/search?q=Skewr+NYC+restaurant", chef:"Inside the Park South Hotel, Skëwr focuses on shareable wood-fired cooking. The menu features a range of meat and vegetable skewers plus large-format dishes like whole branzino and meze.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/skewr"},{name:"Google",url:"https://www.google.com/search?q=Skewr+NYC+Park+South+reservation"}] },
  { id:59, name:"Sushi Yukimi",               neighborhood:"SoHo",             cuisine:"Japanese Omakase",        price:4, difficulty:3, opened:"Feb 2026",       openedDate:new Date("2026-02-10"), status:"open", address:"247A Elizabeth St",     vibe:"Intimate & Seasonal",     isBar:false, reservation:"Booking 1 week out",        dressCode:"Smart Casual",            mealPeriods:["Dinner"],                               homepage:"https://www.google.com/search?q=Sushi+Yukimi+NYC", chef:"An intimate omakase room named for the Japanese concept of 'viewing snow.' A 17-course menu ($189/person) led by a sushi sous chef from Michelin-starred Sushi Nakazawa. Currently BYOB.", bookingLinks:[{name:"Resy",url:"https://resy.com/cities/new-york-ny/venues/sushi-yukimi"},{name:"Google",url:"https://www.google.com/search?q=Sushi+Yukimi+NYC+reservation"}] },
  { id:60, name:"Lumo Ombro",                 neighborhood:"Tribeca",           cuisine:"Café / Cocktail Bar",     price:2, difficulty:2, opened:"Feb 25, 2026",   openedDate:new Date("2026-02-25"), status:"open", address:"78 Leonard St",         vibe:"Cozy & Inventive",        isBar:true,  reservation:"Walk-in Friendly",          dressCode:"Casual",                  mealPeriods:["Breakfast","Lunch","Dinner","Late Night"],homepage:"https://lumo-ombro.com",                   chef:"Café by day, cocktail bar by night. Chef Steven Hubbell (St. Anselm, Michelin-starred Junoon) serves cinnamon-braised beef cheek, glazed mushrooms on grilled masa. Bartender Christopher Lockwood makes olive oil martinis. Curated loose-leaf teas and a warming Champurrado.", bookingLinks:[{name:"Walk-ins",url:"https://lumo-ombro.com"},{name:"Google",url:"https://www.google.com/search?q=Lumo+Ombro+NYC+Tribeca"}] },
  { id:61, name:"Salt Bread Ko",              neighborhood:"Midtown",           cuisine:"Korean Bakery",           price:1, difficulty:1, opened:"Feb 26, 2026",   openedDate:new Date("2026-02-26"), status:"open", address:"4 E 32nd St",           vibe:"Fresh & Trendy",          isBar:false, reservation:"Walk-in Only",              dressCode:"Casual",                  mealPeriods:["Breakfast","Lunch"],                     homepage:"https://www.instagram.com/saltbreadko/",   chef:"K-town's buzzy new Korean salt bread bakery. Buttery, airy salt bread baked by the hour — from savory (caviar-and-scallion cream cheese) to sweet (raspberry-lychee jam). Flavor dips include kimchi bacon, strawberry, and pandan coconut.", bookingLinks:[{name:"Walk-ins Only",url:"https://www.google.com/search?q=Salt+Bread+Ko+NYC"}] },
  // ── Coming Soon from Eater ──
  { id:62, name:"Hi Dozo (Nakazawa)",         neighborhood:"Midtown",           cuisine:"Japanese Sushi",          price:3, difficulty:3, opened:"Fall 2026",      status:"coming_soon", address:"Near Rockefeller Center",vibe:"Exclusive & Precise",    isBar:false, reservation:"Not yet open",              dressCode:"Smart Casual",            mealPeriods:["Lunch","Dinner"],        openingMonth:"Fall 2026",   timelineProgress:0.20, homepage:"https://www.google.com/search?q=Hi+Dozo+Nakazawa+NYC", chef:"DoorDash-exclusive sushi concept from Daisuke Nakazawa — the legendary sushi master behind Michelin-starred Sushi Nakazawa. Opening near Rockefeller Center with delivery and takeout, bringing his exacting Edomae technique to a new format.", bookingLinks:[{name:"DoorDash (Coming Soon)",url:"https://www.doordash.com"},{name:"Google",url:"https://www.google.com/search?q=Hi+Dozo+Nakazawa+NYC"}] },
  { id:63, name:"Lou & Bev's",                neighborhood:"SoHo",             cuisine:"Pizza / Wine Bar",        price:2, difficulty:2, opened:"Spring 2026",    status:"coming_soon", address:"Brooklyn Heights (Atlantic Ave)",vibe:"All-Day & Neighborly",isBar:false, reservation:"Not yet open",              dressCode:"Casual",                  mealPeriods:["Breakfast","Lunch","Dinner"],openingMonth:"Spring 2026",timelineProgress:0.45, homepage:"https://www.google.com/search?q=Lou+Bevs+NYC+bakery+pizza", chef:"An all-day bakery and pizza restaurant with a wine bar from the Confidant team (Henry Goldman, Martin Borkan). Opening next door to the recently relocated Confidant in Brooklyn Heights.", bookingLinks:[{name:"Coming Soon",url:"https://www.google.com/search?q=Lou+Bevs+Brooklyn+Heights+NYC"}] },
  { id:64, name:"Giardino at Giulietta",      neighborhood:"Midtown",           cuisine:"Italian Aperitivo",       price:2, difficulty:1, opened:"Apr 2026",       status:"coming_soon", address:"200 Park Ave (MetLife)",vibe:"Breezy & Social",        isBar:true,  reservation:"Not yet open",              dressCode:"Casual",                  mealPeriods:["Lunch","Dinner","Late Night"],openingMonth:"April 2026",timelineProgress:0.55, homepage:"https://www.giuliettanyc.com",              chef:"The outdoor aperitivo bar and garden extension of Giulietta at the MetLife Building. 150 seats serving spritzes, frozen drinks, and pizzas. Converts to a heated chalet-style lounge in winter.", bookingLinks:[{name:"Coming Soon",url:"https://www.giuliettanyc.com"},{name:"Google",url:"https://www.google.com/search?q=Giardino+Giulietta+NYC+MetLife"}] },
];
